...
from ascbot import __main__ as main

# Copied from: https://github.com/python/bedevere/blob/master/tests/test___main__.py
# LICENSED under: https://github.com/python/bedevere/blob/master/LICENSE
